...
void main() {
  ...
  group('save watchlist', () {
    test(
      ...
      () async {
        // arrange
        when(
          mockDatabaseHelper.insertSeriesWatchlist(testSeriesTable),
  ...
  group('remove watchlist', () {
    test(
      ...
      () async {
        // arrange
        when(
          mockDatabaseHelper.removeSeriesWatchlist(testSeriesTable),
        ).thenAnswer((_) async => 1);
        // act
  ...
  group('Get Series Detail By Id', () {
    ...
    test('should return Series Detail Table when data is found', () async {
      // arrange
      when(
        mockDatabaseHelper.getSeriesById(tId),
  ...
  group('get watchlist series', () {
    test('should return list of Series Table from database', () async {
      // arrange
      when(
        mockDatabaseHelper.getWatchlistSeries(),
      ).thenAnswer((_) async => [testSeriesMap]);
      // act
