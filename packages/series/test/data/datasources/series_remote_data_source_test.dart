...
void main() {
  ...
  group('get Now Playing Series', () {
    final tSeriesList =
        SeriesResponse.fromJson(
          json.decode(readJson('dummy_data/now_playing_series.json')),
        ).seriesList;

    test(
      'should return list of Series Model when the response code is 200',
      () async {
        // arrange
        when(
          ...
          (_) async => http.Response(
            readJson('dummy_data/now_playing_series.json'),
            200,
          ),
        );
        // act
  ...
  group('get Popular Series', () {
    ...
    test(
      'should return list of series when response is success (200)',
      () async {
        // arrange
        when(
  ...
  group('search series', () {
    final tSearchResult =
        SeriesResponse.fromJson(
          json.decode(readJson('dummy_data/search_the_heaven_series.json')),
        ).seriesList;
    ...
    test('should return list of series when response code is 200', () async {
      ...
      when(
        ...
        (_) async => http.Response(
          readJson('dummy_data/search_the_heaven_series.json'),
          200,
        ),
      );
      // act
