...
import 'package:ditonton/features/series/data/models/series_detail_model.dart';
...
void main() {
  ...
  group('get Now Playing Series', () {
    final tSeriesList = SeriesResponse.fromJson(
            json.decode(readJson('series/dummy_data/now_playing_series.json')))
        .seriesList;
    ...
    test('should return list of Series Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/on_the_air?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('series/dummy_data/now_playing_series.json'), 200));
      // act
  ...
  group('get Popular Series', () {
    final tSeriesList = SeriesResponse.fromJson(
            json.decode(readJson('series/dummy_data/popular_series.json')))
        .seriesList;
    ...
    test('should return list of series when response is success (200)',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/popular?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('series/dummy_data/popular_series.json'), 200));
      // act
  ...
  group('get Top Rated Series', () {
    final tSeriesList = SeriesResponse.fromJson(
            json.decode(readJson('/series/dummy_data/top_rated_series.json')))
        .seriesList;
    ...
    test('should return list of series when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('series/dummy_data/top_rated_series.json'), 200));
      // act
  ...
  group('get series detail', () {
    ...
    final tSeriesDetail = SeriesDetailModel.fromJson(
        json.decode(readJson('series/dummy_data/series_detail.json')));

    test('should return series detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('series/dummy_data/series_detail.json'), 200));
      // act
  ...
  group('get series recommendations', () {
    final tSeriesList = SeriesResponse.fromJson(json
            .decode(readJson('series/dummy_data/series_recommendations.json')))
        .seriesList;
    final tId = 1;
    ...
    test('should return list of Series Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('series/dummy_data/series_recommendations.json'), 200));
      // act
  ...
  group('search series', () {
    final tSearchResult = SeriesResponse.fromJson(json.decode(
            readJson('series/dummy_data/search_the_heaven_series.json')))
        .seriesList;
    final tQuery = 'The Heaven and Earth Show';
